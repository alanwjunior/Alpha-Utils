<template>
  <div class="regexifybot">
    <h1>Add Standard Tracking</h1>
    <el-alert
      title="Add standard Trackings to all block that have the bot interaction or wait user message or is marked with [] ont the title. If you add the flag --all at the end will append to all blocks in the builder."
      type="info"
      show-icon>
    </el-alert>
    <el-row>
