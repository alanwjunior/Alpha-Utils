...
export default {
  ...
  methods: {
    ...mapActions(['getBotDetails', 'getBotPublishedFlow', 'regexify', 'notifyError', 'updatePublishedFlow']),
    ...
    async runScripts () {
      try {
        ...
        let updateStatus = await blipService.regexifyBot(updatedFlow, this.selectedBot.shortName)
